...
- **Flags:** `Available`, `Fallback` (nominal 512/399 when EEPROM page `0xA0` was not loaded), `HardwareCal`, `Tracker`, `SoftwareZero` (software-only tracker; cal byte not stepped).
