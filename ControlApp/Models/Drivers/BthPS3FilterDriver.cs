        ...
        set
        {
            ...
            try
            {
                ...
                if (value)
                {
                    ...
                    PInvoke.DeviceIoControl(handle, IOCTL_BTHPS3PSM_ENABLE_PSM_PATCHING, enableIn, default, null);
                }
                else
                {
                    ...
                    PInvoke.DeviceIoControl(handle, IOCTL_BTHPS3PSM_DISABLE_PSM_PATCHING, disableIn, default, null);
                }
            }
            finally
            {
